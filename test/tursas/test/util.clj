...
(deftest coordinate-test
  (testing "Coordinate validation"
    (is (= (valid-coord? "e3") true))
    (is (= (valid-coord? "a8") true))
    (is (= (valid-coord? "a9") false))
    (is (= (valid-coord? "i2") false))
    (is (= (valid-coord? "v3") false))
    (is (= (valid-coord? "a22") false))
    (is (= (valid-coord? "aa2") false))
    ...
    (is (true? (coordinate-string? "0000")))
